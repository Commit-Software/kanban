...
export const getUsageStats = async (query) => {
    let q = knex('tasks')
    ...
    const tasks = await q.select('id', 'title', 'claimed_by', 'usage_input_tokens', 'usage_output_tokens', 'usage_model', 'usage_cost_usd', 'updated_at');
    // Calculate totals
    const totals = {
